...
namespace KBEngine
{
	...
	public class DATATYPE_HERO_IDS_LIST : DATATYPE_BASE
	{
		public HERO_IDS_LIST createFromStreamEx(MemoryStream stream)
		{
			UInt32 size = stream.readUint32();
			HERO_IDS_LIST datas = new HERO_IDS_LIST();
		...
		public void addToStreamEx(Bundle stream, HERO_IDS_LIST v)
		{
	...
	public class DATATYPE_HERO_INFOS : DATATYPE_BASE
	{
	...
	public class DATATYPE_SKILL_INFOS : DATATYPE_BASE
	{
	...
	public class DATATYPE_SKILL_INFOS_LIST : DATATYPE_BASE
	{
		private DATATYPE_SKILL_INFOS itemType = new DATATYPE_SKILL_INFOS();
	...
	public class DATATYPE_SHOP_INFOS : DATATYPE_BASE
	{
	...
	public class DATATYPE_SHOP_INFOS_LIST : DATATYPE_BASE
	{
		private DATATYPE_SHOP_INFOS itemType = new DATATYPE_SHOP_INFOS();

		public SHOP_INFOS_LIST createFromStreamEx(MemoryStream stream)
		{
			UInt32 size = stream.readUint32();
			SHOP_INFOS_LIST datas = new SHOP_INFOS_LIST();
		...
		public void addToStreamEx(Bundle stream, SHOP_INFOS_LIST v)
		{
			stream.writeUint32((UInt32)v.Count);
			for(int i=0; i<v.Count; ++i)
			{
	...
	public class DATATYPE_PROPS_INFOS : DATATYPE_BASE
	{
		public PROPS_INFOS createFromStreamEx(MemoryStream stream)
		{
			PROPS_INFOS datas = new PROPS_INFOS();
			datas.prop_id = stream.readInt32();
			datas.prop_name = stream.readUnicode();
			datas.prop_icon = stream.readUnicode();
		...
		public void addToStreamEx(Bundle stream, PROPS_INFOS v)
		{
			stream.writeInt32(v.prop_id);
			stream.writeUnicode(v.prop_name);
			stream.writeUnicode(v.prop_icon);
	...
	public class DATATYPE_PROPS_INFOS_LIST : DATATYPE_BASE
	{
		private DATATYPE_PROPS_INFOS itemType = new DATATYPE_PROPS_INFOS();
	...
	{
		private DATATYPE__MATCHING_INFOS_heroIdLst_ArrayType_ChildArray heroIdLst_DataType = new DATATYPE__MATCHING_INFOS_heroIdLst_ArrayType_ChildArray();

		public class DATATYPE__MATCHING_INFOS_heroIdLst_ArrayType_ChildArray : DATATYPE_BASE
		{
