/*
	...
	Please inherit this module, such as: (class MatchRoomReport : MatchRoomReportBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	public abstract class MatchRoomReportBase : EntityComponent
	{
		public EntityBaseEntityCall_MatchRoomReportBase baseEntityCall = null;
		public EntityCellEntityCall_MatchRoomReportBase cellEntityCall = null;
		...
		public override void createFromStream(MemoryStream stream)
		{
			...
			baseEntityCall = new EntityBaseEntityCall_MatchRoomReportBase(entityComponentPropertyID, ownerID);
			cellEntityCall = new EntityCellEntityCall_MatchRoomReportBase(entityComponentPropertyID, ownerID);
		}

		public override ScriptModule getScriptModule()
		{
			return EntityDef.moduledefs["MatchRoomReport"];
		}
